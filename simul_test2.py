...
if __name__ == '__main__':
    ...
    with tf.Session() as sess:
        ...
        irradiancias = list([1000., 1000., 1000.]) #list([1000., 500., 1000., 500., 900., 600., 800., 400., 100.]) #irradiancias = list([1000., 1000., 800., 700.]) #list([100., 200., 300., 400., 500., 600., 700., 800., 900., 1000])
        temperaturas = list([25., 25., 25.]) #list([25.0, 25.00, 27.5,  27.50, 29.0, 29., 23.0, 23.0, 23.]) #temperaturas = list([25.0, 27.5, 25., 22.3]) #list([13.5, 15., 17.5, 20., 22.5, 25., 27.5, 30., 32.5, 35])
        sh = list([[4, 10, 7, 10, 10, 10],[2, 10, 10, 10, 7, 10],[8, 10, 6, 10, 5, 10]])# list([[4, 10, 7, 10, 10, 10],[4, 10, 7, 10, 10, 10],[4, 10, 7, 10, 10, 10],[4, 10, 7, 10, 10, 10]]) #tengo que completar esa lista con tantas tuplas como temperatras e irr haya....si tengo 5 temperaturas, por tanto tengo que poner 5 tuplas, variandolas o no...como quiera...
        ...
        np.save('Potencia_TD3',grafos.P)
        np.save('Tension_TD3',grafos.V)
        np.save('Corriente_TD3',grafos.I)
        np.save('Acciones_TD3',grafos.acciones)
